...
git add pom.xml README.md document/readTechnicalStructure.md document/PUBLISHING.md CLIENT-DEPENDENCY.xml distribution/release.sh distribution/create-distribution.sh .gitignore
